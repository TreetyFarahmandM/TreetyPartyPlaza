...
namespace PartyPlaza
{
    internal class MySupplier : MyEntity
    {
        ...
        public MySupplier(int idNo, string title, string businessName, String ContactSurname, string forename, string street, string town, string county, string postcode, string telNo)
